...
import * as Producer from '../controllers/producerController';
...
// Auth routes
router.get('/auth/nonce', Auth.getNonce);
router.post('/auth/login', Auth.login);
router.get('/auth/profile', requireAuth, Auth.profile);
...
// Producer routes
router.post('/producer/request', requireAuth, Producer.createProductionRequest);
router.post('/producer/mint', requireAuth, Producer.claimMint);

// Admin routes
router.post('/admin/certify', requireAuth, Admin.certifyRequest);
router.post('/admin/approve-role', requireAuth, (req, res) => Auth.approveRole(req, res));

// Marketplace routes
router.post('/market/list', requireAuth, Market.createListing);
router.post('/market/buy', requireAuth, Market.buy);

// Auditor export
router.get('/audit/export', Audit.exportAudit);

// Get specific token information (placeholder)
