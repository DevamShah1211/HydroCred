...
import { Shield, Users, Leaf, BarChart3, Crown, Building2 } from 'lucide-react';
...
const Home: React.FC = () => {
  const roles = [
    {
      title: 'Main Admin',
      description: 'Assign state administrators and manage system configuration',
    ...
    {
      title: 'State Admin',
      description: 'Approve producer token requests for your assigned state',
    ...
    {
      title: 'Producer',
      description: 'Register state/city and request tokens from state admins',
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Hierarchical blockchain-powered green hydrogen credit system with state-aware approval workflows.
                Issue, transfer, and retire verified hydrogen production credits through a structured admin hierarchy.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="bg-gray-800/50 px-6 py-3 rounded-xl border border-gray-700">
                <span className="text-brand font-semibold">State-Aware System</span>
              </div>
              <div className="bg-gray-800/50 px-6 py-3 rounded-xl border border-gray-700">
                <span className="text-brand font-semibold">Hierarchical Approval</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Discover Verified Producers</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Browse verified green hydrogen producers and connect with them directly to purchase credits
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Hierarchical Control</h3>
              <p className="text-gray-400">Multi-level admin system with state-based approval workflows</p>
            </div>
